...
5. WRONG_ROUTE、FALSE_FALLBACK、FORCED_ANSWER、WRONG_FALLBACK_TIER、FALLBACK_TEXT_MISMATCH、UNKNOWN_OUTPUT、EMPTY_OR_ERROR清单；INCONSISTENT清单以 Consistency_Flag 列为准；BLOCKED/CASE_NOT_FOUND 行单独列为数据问题；
6. 知识库缺口、合规待办和产品规则缺口；
